  ...
  <div class="min-h-screen bg-white font-sans" :style="cssVars">
        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div class="flex items-center gap-4 text-sm text-gray-500">
              ...
              <span><strong class="text-gray-800">500+</strong> clinics trust ClinicOS</span>
          ...
          <div class="relative hidden lg:block">
            <div class="bg-gray-900 rounded-3xl shadow-2xl overflow-hidden border border-gray-800 ring-1 ring-white/10">
              ...
              <div class="flex items-center gap-2 px-4 py-3 border-b border-gray-800">
                ...
                <div class="flex-1 mx-4 bg-gray-800 rounded-lg px-3 py-1 text-xs text-gray-400 text-center">app.clinicos.in/dashboard</div>
              </div>
              <!-- App content -->
    ...
    <section class="py-24 px-6" :style="{ background: clinic.color + '06' }">
      <div class="max-w-6xl mx-auto">
        <div class="text-center mb-16">
          <h2 class="text-4xl font-black text-gray-900 mb-4">Doctors love ClinicOS</h2>
    ...
    <section class="py-24 px-6 text-center relative overflow-hidden">
      ...
      <div class="max-w-3xl mx-auto">
        ...
        <p class="text-xl text-gray-500 mb-10">Join 500+ clinics already saving 2 hours a day with ClinicOS. Setup takes under 10 minutes.</p>
    ...
    <footer class="bg-gray-900 text-gray-400 py-16 px-6">
      <div class="max-w-7xl mx-auto">
        ...
        <div class="border-t border-gray-800 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-sm">
          <span>© 2025 ClinicOS. All rights reserved.</span>
...
const CLINIC_CONFIGS = {
  ...
  default: {
    brand: 'ClinicOS', emoji: '⚕️', color: '#2563eb',
...
const modules = computed(() => [
  ...
  },
  {
    ...
    points: [
      'Custom subdomain (yourclinic.clinicos.app) in seconds',
...
const testimonials = computed(() => [
  {
    ...
    text: "ClinicOS cut our patient wait time in half. The live queue display is the best feature — patients actually come on time now because they can track their token from home.",
  },
  {
...
const faqs = reactive([
  ...
  { q: 'Do I need to install anything?', a: 'No. ClinicOS is fully web-based. Works on any computer, tablet, or phone browser. Your staff don\'t need to install anything — just log in.', open: false },
