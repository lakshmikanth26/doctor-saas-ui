  ...
  <div>
    <div class="page-header">
      ...
      <div class="flex gap-2">
        <a v-if="site?.subdomain" :href="`https://${site.subdomain}.clinova.app`" target="_blank" class="btn-secondary btn-sm">
          🔗 Preview
        </a>
      ...
      <form @submit.prevent="saveSettings" class="card space-y-4">
        ...
        <div><label class="label">Subdomain</label>
          <div class="flex items-center">
            ...
            <span class="bg-gray-100 border border-l-0 border-white/10 rounded-r-lg px-3 py-2 text-sm text-slate-500">.clinova.app</span>
          </div>
        </div>
