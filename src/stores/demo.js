...
export const DEMO_STEPS = [
  ...
  },
  {
    ...
    insight: `Adding a patient takes less than a minute. ClinicOS auto-generates a unique MRN (Medical Record Number) so you never duplicate records. Enter name, phone, date of birth, and optional details like blood group and emergency contact — that's it.`,
  ...
  },
  {
    ...
    insight: `Book appointments in 3 clicks: pick the patient, choose a doctor, and select an open slot. ClinicOS automatically assigns a token number and sends an SMS confirmation. The patient can check their queue position from home before leaving.`,
  ...
  },
  {
    ...
    insight: `Track every medicine, consumable, and equipment item. Set a reorder level and ClinicOS automatically flags items that need restocking. Every prescription auto-deducts from inventory so your stock count is always accurate without manual counting.`,
  ...
  },
  {
    ...
    insight: `Every clinic on ClinicOS gets a free public website at yourclinic.clinicos.app. Add your services, team, gallery, and a blog. Patients can book appointments directly from your website. No developer or hosting costs — ever.`,
  ...
  },
  {
    ...
    insight: `Share a public URL with every patient after booking. They check their token position from home, arrive exactly when needed, and the waiting room stays calm. Put it on a TV screen, a WhatsApp message, or embed it on your website — it\'s a public page, no login required.`,
    tip: 'Tip: Click the 📺 Queue Display button in the top bar to open the TV-friendly full-screen view.',
  },
  {
    id: 'settings',
    path: '/settings',
